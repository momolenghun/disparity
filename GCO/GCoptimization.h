...
{
public: 
	typedef totalvalue EnergyType;
	typedef value EnergyTermType;
	typedef typename Energy<value,totalvalue>::Var VarID;              
	...
	EnergyType expansion(int max_num_iterations= std::numeric_limits<int>::max());
	...
	EnergyType swap(int max_num_iterations=std::numeric_limits<int>::max());
	...
	inline void setLabel(SiteID site, LabelID label){
		assert(label >= 0 && label < m_num_sites && site >= 0 && site < m_num_sites);m_labeling[site] = label;};
	...
	m_datacostFnDelete         = deleteFunctor<UserFunctor>;
	m_giveDataEnergyInternal   = &GCoptimization<value, totalvalue>::template giveDataEnergyInternal<UserFunctor>;
	m_set_up_t_links_expansion = &GCoptimization<value, totalvalue>::template set_up_t_links_expansion<UserFunctor>;
	m_set_up_t_links_swap      = &GCoptimization<value, totalvalue>::template set_up_t_links_swap<UserFunctor>;
}
	...
	m_smoothcostFnDelete       = deleteFunctor<UserFunctor>;
	m_giveSmoothEnergyInternal = &GCoptimization<value, totalvalue>::template giveSmoothEnergyInternal<UserFunctor>;
	m_set_up_n_links_expansion = &GCoptimization<value, totalvalue>::template set_up_n_links_expansion<UserFunctor>;
	m_set_up_n_links_swap      = &GCoptimization<value, totalvalue>::template set_up_n_links_swap<UserFunctor>;
}
...
protected:
	...
	void (GCoptimization<value,totalvalue>::*m_set_up_n_links_expansion)(SiteID,LabelID,Energy<value,totalvalue>*,VarID*,SiteID*);
	void (GCoptimization<value,totalvalue>::*m_set_up_t_links_expansion)(SiteID,LabelID,Energy<value,totalvalue>*,VarID*,SiteID*);
	void (GCoptimization<value,totalvalue>::*m_set_up_n_links_swap)(SiteID,LabelID,LabelID,Energy<value,totalvalue>*,VarID*,SiteID*);
	void (GCoptimization<value,totalvalue>::*m_set_up_t_links_swap)(SiteID,LabelID,LabelID,Energy<value,totalvalue>*,VarID*,SiteID*);
	...
	void set_up_t_links_expansion(SiteID size, LabelID alpha_label,Energy<value,totalvalue> *e,VarID *variables, SiteID *activeSites );

	template <typename DataCostT> 
	void set_up_t_links_swap(SiteID size, LabelID alpha_label,LabelID beta_label,Energy<value,totalvalue> *e,VarID *variables, SiteID *activeSites );

	template <typename SmoothCostT> 
	void set_up_n_links_expansion(SiteID size, LabelID alpha_label,Energy<value,totalvalue> *e,VarID *variables,SiteID *activeSites );

	template <typename SmoothCostT> 
	void set_up_n_links_swap(SiteID size, LabelID alpha_label,LabelID beta_label,Energy<value,totalvalue> *e,VarID *variables,SiteID *activeSites );
...
private:
	...
	void set_up_expansion_energy(SiteID size, LabelID alpha_label,Energy<value,totalvalue> *e,VarID *variables, SiteID *activeSites );
	...
	void set_up_swap_energy(SiteID size,LabelID alpha_label,LabelID beta_label,
							Energy<value,totalvalue>* e,typename Energy<value,totalvalue>::Var *variables,SiteID *activeSites);
...
template <typename value,typename totalvalue>
class GCoptimizationGridGraph: public GCoptimization<value,totalvalue>
{
public:
	typedef totalvalue EnergyType;
	typedef value EnergyTermType;
...
template <typename value,typename totalvalue>
class GCoptimizationGeneralGraph:public GCoptimization<value,totalvalue>
{
...
template <typename DataCostT>
typename GCoptimization<V,T>::EnergyType GCoptimization<V,T>::giveDataEnergyInternal()
{
...
template <typename V,typename T>
template <typename SmoothCostT>
typename GCoptimization<V,T>::EnergyType GCoptimization<V,T>::giveSmoothEnergyInternal()
{
...
template <typename V,typename T>
template <typename DataCostT>
void GCoptimization<V,T>::set_up_t_links_expansion(SiteID size, LabelID alpha_label,Energy<V,T> *e,
...
template <typename V,typename T>
template <typename SmoothCostT>
void GCoptimization<V,T>::set_up_n_links_expansion(SiteID size, LabelID alpha_label,Energy<V,T> *e,
     										  VarID *variables,SiteID *activeSites )
{
...
template <typename V,typename T>
template <typename DataCostT>
void GCoptimization<V,T>::set_up_t_links_swap(SiteID size, LabelID alpha_label, LabelID beta_label,
										 Energy<V,T> *e,VarID *variables,SiteID *activeSites )
{
	DataCostT* dc = (DataCostT*)m_datacostFn;
...
template <typename V,typename T>
template <typename SmoothCostT>
void GCoptimization<V,T>::set_up_n_links_swap(SiteID size, LabelID alpha_label,LabelID beta_label,
										 Energy<V,T> *e,VarID *variables,SiteID *activeSites )
{
	SiteID i,nSite,site,n,nNum,*nPointer;
	EnergyTermType *weights;
